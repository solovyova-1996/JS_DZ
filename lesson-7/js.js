...
const check = {
    ...
    render() {
        ...
        checkEl.innerHTML = `Счёт: ${this.check}`
    },
    checkAdd() {
        this.check++
    },
...
const map = {
    ...
    render(snakePointsArray, foodPoint, obstaclesPoint) {
        ...
        const obstaclesCellKey = `x${obstaclesPoint.x}_y${obstaclesPoint.y}`;
        const obstaclesCell = this.cells[obstaclesCellKey];
...
const game = {
    ...
    reset() {
        ...
        this.obstacles.setCoordinates(this.getRandomFreeCoordinateso());
        this.render();
    },

    render() {

        this.map.render(this.snake.body, this.food.getCoordinates(), this.obstacles.getCoordinates());
    },
    ...
    tickHandler() {
        ...
        } else if (this.obstacles.isOnPoint(this.snake.getNextHeadPoint())) {
            return this.finish()
